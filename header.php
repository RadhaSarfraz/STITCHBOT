...
<head>
    ...
    <script defer="defer" src="./static/js/main.268f2b91.js"></script>
    <link href="./static/css/main.024150da.css" rel="stylesheet" />
</head>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    if (!empty($header[0]['site_logo'])) { ?>
                       <h2 style="color:#ed420e;">Stitch Bot</h2>
                    <?php } else { ?>
